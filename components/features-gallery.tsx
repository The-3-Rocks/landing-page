      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="pt-6 pb-12 md:pt-8 md:pb-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            <h2 className="h2 font-red-hat-display mb-4">We are honered by your trust to manage your sales and merchandising</h2>
            <p className="text-xl text-gray-600 dark:text-gray-400">Our team is arround the world helping your companies to reach suppliers and costumers to get the best results and reach the furthest goals</p>
          </div>
          ...
          <div className="max-w-sm mx-auto grid grid-cols-2 gap-4 gap-y-8 sm:gap-8 md:grid-cols-4 items-start md:max-w-5xl">
            ...
            <div className="relative flex flex-col items-center">
              ...
              <div className="sm:text-lg font-medium dark:text-gray-300">Honesty</div>
            </div>
            ...
            <div className="relative flex flex-col items-center">
              ...
              <div className="sm:text-lg font-medium dark:text-gray-300">Transparency</div>
            </div>
            ...
            <div className="relative flex flex-col items-center">
              ...
              <div className="sm:text-lg font-medium dark:text-gray-300">Adabtiblity</div>
            </div>
            ...
            <div className="relative flex flex-col items-center">
              ...
              <div className="sm:text-lg font-medium dark:text-gray-300">Innovation</div>
            </div>
