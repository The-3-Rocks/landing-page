...
export const CardStack = React.forwardRef(function CardStackInner<T extends CardStackItem>(
  props: CardStackProps<T>,
  ...
  React.useImperativeHandle(ref, () => ({ prev, next }), [prev, next]);
    ...
    >
      ...
      >
        ...
        <div
          ...
          style={{ perspective: `${perspectivePx}px`, marginBottom: 55 }}
        >
...
}) as <T extends CardStackItem>(props: CardStackProps<T> & { ref?: React.Ref<CardStackHandle> }) => React.ReactElement;
    ...
    <div className="relative h-full w-full">
      <div className="absolute inset-0">
        {item.imageSrc ? (
          ...
          <div className="flex h-full w-full items-center justify-center bg-gray-100 dark:bg-gray-800 text-sm text-gray-500 dark:text-gray-400">
            No image
          </div>
        )}
      </div>
