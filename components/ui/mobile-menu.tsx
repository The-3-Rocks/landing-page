...
export default function MobileMenu() {
  ...
  return (
    <div className="inline-flex md:hidden">
      ...
      <ThemeToggle className="mr-6" id="theme-toggle-mobile" />
            ...
            <ul>
              ...
              <li>
                <Link
                  ...
                  className="inline-flex items-center px-6 py-4 border border-transparent text-sm font-medium rounded-md shadow-sm text-white bg-teal-700 hover:bg-teal-800 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-teal-500 transition-colors duration-150 ml-0 mt-4"
                >
