        ...
        <div className="py-12 md:py-20 border-t border-gray-200 dark:border-gray-800">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            <h2 className="h2 font-red-hat-display">
              Optimizing Raw Material Supply: Our Four Pillars
            </h2>
          </div>
          ...
          >
            ...
            >
              ...
              <div className="grow opacity-80 mb-4">
                Connecting buyers and sellers of mining raw materials.
              </div>
              <svg
            ...
            >
              ...
              <div className="grow opacity-80 mb-4">
                Efficient, reliable transactions every time.
              </div>
              <svg
                className="w-6 h-6 self-end transform -translate-x-2 group-hover:translate-x-0 transition duration-150 ease-in-out"
                viewBox="0 0 24 24"
            ...
            >
              ...
              <div className="grow opacity-80 mb-4">
                Ensuring smooth procurement and delivery.
              </div>
              <svg
                className="w-6 h-6 self-end transform -translate-x-2 group-hover:translate-x-0 transition duration-150 ease-in-out"
                viewBox="0 0 24 24"
            ...
            >
              ...
              <div className="grow opacity-80 mb-4">
                Fostering robust business relationships.
              </div>
              <svg
                className="w-6 h-6 self-end transform -translate-x-2 group-hover:translate-x-0 transition duration-150 ease-in-out"
                viewBox="0 0 24 24"
