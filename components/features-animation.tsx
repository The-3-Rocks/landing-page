        ...
        <div className="py-12 md:py-20 border-t border-gray-200 dark:border-gray-800">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-16">
            ...
            <p className="text-xl text-gray-600 dark:text-gray-400">
              ...
              minerals, non-metallic minerals, energy resources, construction
              materials, and industrial chemicals. Our commitment to
              sustainability and environmental responsibility ensures that our
              materials meet the highest standards for your projects and
              applications.
            </p>
          </div>
