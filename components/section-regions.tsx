  ...
  return (
    <section className="bg-white dark:bg-gray-900 border-b border-gray-200 dark:border-gray-800">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 py-16">
        ...
        <div
          className="group relative flex items-start gap-4 p-6 rounded-xl transition-all duration-300 hover:-translate-y-0.5 hover:shadow-sm"
        ...
        >
          ...
          <div>
            ...
            <p className="text-[15px] leading-relaxed text-gray-500 dark:text-gray-400">
              We maintain direct relationships with mines in every region &mdash;
              so we can match grade profiles and impurity signatures to your
